...
function makeAuthWindow(provider,retpath,callback){
    var providers = {
            facebook:{
                url:'https://www.facebook.com/dialog/oauth?client_id=210476312380425&redirect_uri='+retpath+provider,
                width:900,
                height:400
            },
            vkontakt:{
                url:'http://oauth.vk.com/authorize?client_id=2769050&display=popup&response_type=code&redirect_uri='+retpath+provider,
                width:600,
                height:300
            },
            logout:{
                url:'http://perekrili.org/logout',
                width:600,
                height:300
            }
        },
